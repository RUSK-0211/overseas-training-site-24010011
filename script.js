        ...
        sections: [
            {
                type: "text",
                heading: "自然体験",
                text: "ヨセミテ国立公園では、ノースフェイスやブライダルヴェールなどの壮大な自然を実際に目にすることができました。\n音や空気、スケール感を含めて、体全体で自然を感じる貴重な体験となりました。"
            },
            {
                type: "text",
                heading: "文化的背景",
                text: "ガイドの方から先住民であるインディアンの人々と自然との関わりについての話を聞き、この大自然が生活や文化と深く結びついてきた存在であることを知りました。"
            },
            {
                type: "text",
                heading: "ITとの関連",
